...
from .views import CandidateView,TestDetailsView,CreateTestView,AllQuestionsView,QuestionsByTestIdView,AddQuestionView,DeleteQuestionView,UpdateQuestionView,TestCandidateCreateView,RecruiterCandidateResults,TestSubmissionView
